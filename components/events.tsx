        ...
        >
          {days.map((item) => (
            <button
              ...
              className={`min-w-0 rounded-xl border-2 px-2 py-3 text-center transition-colors ${day === item.day ? "border-[#5D0826] bg-[#5D0826] text-white" : "border-[#E8D4DB] text-[#8E0C3A] hover:bg-[#FAF6F7]"}`}
            >
