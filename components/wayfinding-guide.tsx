      ...
      <div className="mx-auto max-w-[1180px]">
        <div className="mx-auto mb-10 max-w-3xl text-center">
          ...
          <p className="mt-4 text-base leading-relaxed text-[#1E1E1E]/75 sm:text-lg">
            {isFr
              ? "Ces plans simplifiés mettent en évidence les espaces utilisés par le Sommet. Ils servent au repérage et ne sont pas à l’échelle."
              : "These simplified plans highlight the spaces used by the Summit. They are for orientation and are not to scale."}
          </p>
        </div>
          ...
          <article className="rounded-3xl border border-[#E8D4DB] bg-white p-6 shadow-sm sm:p-8">
            <div className="mb-5 flex items-center justify-between gap-4">
              <div>
                ...
                <h3 className="font-heading text-2xl font-black text-[#5D1831]">
                  {isFr ? "Plénières et hall D" : "Plenaries and Hall D"}
                </h3>
              </div>
              <ArrowUpDown className="size-8 text-[#8C0C3A]" aria-hidden />
            </div>
            <div className="rounded-2xl bg-[#FAF6F7] p-4">
              ...
              <div className="mt-4 rounded-full border border-dashed border-[#8C0C3A] bg-white px-4 py-2 text-center text-xs font-bold text-[#8C0C3A]">
                {isFr
                  ? "Le hall C relie les bâtiments nord et sud; le hall D se trouve près du corridor Carlton."
                  : "Hall C connects the north and south buildings; Hall D is beside the Carlton Concourse."}
              </div>
            </div>
          </article>
        </div>
