  ...
  return (
    <div
      className={`flex min-h-20 items-center justify-center rounded-xl border-2 px-3 py-4 text-center font-heading text-sm font-black sm:text-base ${
        emphasis
          ? "border-[#8E0C3A] bg-[#8E0C3A] text-white"
          : "border-[#D8C1C9] bg-white text-[#8E0C3A]"
      }`}
    >
      {children}
    </div>
      ...
      <div className="mx-auto max-w-[1180px]">
        ...
        <div className="grid gap-7 lg:grid-cols-3">
          <article className="rounded-3xl border border-[#E8D4DB] bg-white p-6 shadow-sm sm:p-8">
            <div className="mb-5 flex items-center justify-between gap-4">
              <div>
                <p className="text-sm font-bold uppercase tracking-[0.12em] text-[#8E0C3A]">
                  {isFr ? "Niveau 1" : "Level 1"}
                </p>
                <h3 className="font-heading text-2xl font-black text-[#8E0C3A]">
                  {isFr ? "Arrivée et inscription" : "Arrival & registration"}
                </h3>
              </div>
              <MapPin className="size-8 text-[#8E0C3A]" aria-hidden />
            </div>
            <div className="rounded-2xl bg-[#FAF6F7] p-4">
              ...
              <div className="mx-auto h-7 w-px border-l-2 border-dashed border-[#8E0C3A]" />
              ...
              <p className="mt-4 text-center text-xs font-semibold leading-relaxed text-[#8E0C3A]/75">
                {isFr
          ...
          <article className="rounded-3xl border border-[#E8D4DB] bg-white p-6 shadow-sm sm:p-8">
            <div className="mb-5 flex items-center justify-between gap-4">
              ...
              <ArrowUpDown className="size-8 text-[#8E0C3A]" aria-hidden />
            </div>
            <div className="rounded-2xl bg-[#FAF6F7] p-4">
              <p className="mb-3 text-center text-xs font-bold uppercase tracking-[0.12em] text-[#8E0C3A]/70">
              ...
              <div className="mx-auto mt-4 max-w-xs rounded-full border border-dashed border-[#8E0C3A] bg-white px-4 py-2 text-center text-xs font-bold text-[#8E0C3A]">
                {isFr
          ...
          <article className="rounded-3xl border border-[#E8D4DB] bg-white p-6 shadow-sm sm:p-8">
            ...
            <div className="rounded-2xl bg-[#FAF6F7] p-4">
              ...
              <div className="mt-4 rounded-full border border-dashed border-[#8E0C3A] bg-white px-4 py-2 text-center text-xs font-bold text-[#8E0C3A]">
                {isFr
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full border border-[#8E0C3A] bg-white px-5 py-3 font-bold text-[#8E0C3A]"
          >
          ...
          <Link
            href="/summit-week"
            className="inline-flex items-center gap-2 rounded-full bg-[#8E0C3A] px-5 py-3 font-bold text-white"
          >
