    ...
    <section id="summit-advisory" className="bg-[#FAF6F7] px-5 py-14 sm:py-20">
      <div className="mx-auto max-w-[1180px]">
        <div className="mb-9 max-w-4xl">
          ...
          <p className="mt-4 font-bold text-[#8E0C3A]">
            {isFr
        ...
        <div className="overflow-hidden rounded-3xl border border-[#E8D4DB] bg-white shadow-[0_16px_45px_rgba(142,12,58,0.06)]">
          <div className="hidden grid-cols-[minmax(0,0.75fr)_minmax(0,1.25fr)] bg-[#8E0C3A] px-6 py-4 text-sm font-black uppercase tracking-[0.1em] text-white sm:grid">
          ...
          <ul>
            {ADVISORY_SUBCOMMITTEE.map((member, index) => (
              ...
              >
                <span className="font-bold text-[#8E0C3A]">{member.name}</span>
