      ...
      >
        ...
        {links.map((item) => (
          <a
            ...
            className={`flex min-h-11 shrink-0 items-center whitespace-nowrap rounded-full px-4 py-2 text-sm font-semibold ${section === item.id ? "bg-[#5D0826] text-white" : "text-[#8E0C3A] hover:bg-[#FAF6F7]"}`}
          >
            {item.label}
          </a>
        ))}
