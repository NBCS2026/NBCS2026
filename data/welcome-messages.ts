...
export const WELCOME_MESSAGES: WelcomeMessage[] = [
  {
    ...
    paragraphsEn: [
      ...
      "We extend our warmest thanks to the Honourable Uzoma Asagwara and the Honourable Jamie Moses, who, together with their teams, have provided unwavering support for the Summit. We are equally grateful to Councillor Marcus Chambers, Deputy Mayor of Winnipeg, whose support has been invaluable. Our deepest gratitude goes to Angela Cassie, who has led the remarkable local organizing committee with exceptional insight, and to Winnipeg’s entire Black community, English- and French-speaking alike, whose commitment and tremendous efforts to welcome this Summit we warmly acknowledge.",
  ...
  },
  {
    ...
    titleFr: "Un mot au nom de la Province du Manitoba",
    paragraphsEn: [
      "On behalf of Premier Wab Kinew and the Province of Manitoba, it is my great pleasure to welcome you to Winnipeg for the 2026 National Black Canadians Summit as the Minister for Business, Mining, Trade and Job Creation.",
    ...
    paragraphsFr: [
      "Au nom du premier ministre Wab Kinew et de la Province du Manitoba, j’ai le grand plaisir de vous accueillir à Winnipeg à l’occasion du Sommet pancanadien des communautés noires 2026, en ma qualité de ministre des Entreprises, des Mines, du Commerce et de la Création d’emplois.",
