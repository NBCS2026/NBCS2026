...
export const WELCOME_MESSAGES: WelcomeMessage[] = [
  ...
  },
  {
    ...
    paragraphsEn: [
      "On behalf of Premier Wab Kinew and the Province of Manitoba, it is our great pleasure to welcome you to Winnipeg for the 2026 National Black Canadians Summit.",
    ...
    paragraphsFr: [
      "Au nom du premier ministre Wab Kinew et de la Province du Manitoba, nous avons le grand plaisir de vous accueillir à Winnipeg à l’occasion du Sommet pancanadien des communautés noires 2026.",
