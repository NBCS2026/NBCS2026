...
export const SUMMIT_WEEK_EVENTS: SummitWeekEvent[] = [
  ...
  "descriptionEn": "Meet the artists behind Together in Motion: Black and Indigenous Futures in Treaty 1 Territory and discover the ideas and stories behind the exhibition. This gathering also marks the opening of Culture Days, the annual pan-Canadian celebration of arts, culture and heritage.",
  "descriptionFr": "Rencontrez les artistes de l’exposition En mouvement ensemble : avenirs noirs et autochtones sur le territoire du Traité no 1 et découvrez les idées et les récits qui inspirent leurs œuvres. Cette rencontre marque aussi le début de la Fête de la culture, la célébration annuelle pancanadienne des arts, de la culture et du patrimoine.",
