  ...
  },
{
  ...
  },
  {
    ...
    bioEn: "Zilla Jones is an African-Canadian lawyer, writer and educator of Afro-Caribbean, Chinese and European descent living and working in Treaty 1 territory (Winnipeg). She received her Bachelor of Musical Arts degree from Canadian Mennonite University and her law degree from the University of Manitoba in 2011, where she won many academic and community service awards and graduated with fourth highest standing in the class. She practices criminal defence and human rights law with Jones Law Office in Winnipeg, serves as duty counsel for Legal Aid Manitoba, and has appeared at all levels of court in Manitoba and the Supreme Court of Canada. She teaches at the Faculty of Law at the University of Manitoba.\n\nZilla is the co-author and member of the Steering Group for Canada’s Black Justice Strategy, an initiative of the federal Minister of Justice, which made 114 recommendations to the Minister to eliminate anti-Black racism in Canada’s justice system. She currently sits on the Implementation Group for the Strategy with Justice Canada. Zilla is also the Past Chair of the Board of Directors of the John Howard Society of Manitoba and a member of the Board of the John Howard Society of Canada. She is the winner of the 2025 Manitoba Bar Association Access to Justice award.\n\nAs a public speaker and anti-racism educator, Zilla has presented to groups across the country, including the University of Manitoba, Dalhousie University Prison Justice, University of Toronto, Law Society of Manitoba, Canadian Association of Black Lawyers, Organization for Economic Cooperation and Development, Black Opportunity Fund, Commonwealth Bar Association, and many more. She has twice represented Canada at the United Nations Permanent Forum for People of African Descent.\n\nZilla is also an acclaimed published fiction writer who has won the Journey Prize and the Writers Trust Rising Star award, amongst other accolades. Her debut novel, The World So Wide, was published this past spring, a collection of short stories will follow in 2027, and a second novel in 2028.",
    bioFr: "Zilla Jones est une avocate, écrivaine et éducatrice afro-canadienne d’ascendance afro-caribéenne, chinoise et européenne qui vit et travaille sur le territoire du Traité no 1, à Winnipeg. Elle est titulaire d’un baccalauréat en arts musicaux de l’Université mennonite canadienne et d’un diplôme en droit de l’Université du Manitoba, obtenu en 2011. Elle y a remporté de nombreux prix d’excellence universitaire et d’engagement communautaire et a terminé au quatrième rang de sa promotion. Elle pratique le droit criminel de la défense et le droit de la personne au cabinet Jones Law Office à Winnipeg, agit comme avocate de service pour Aide juridique Manitoba et a plaidé devant toutes les instances judiciaires du Manitoba ainsi que devant la Cour suprême du Canada. Elle enseigne à la Faculté de droit de l’Université du Manitoba.\n\nZilla est coauteure de la Stratégie canadienne en matière de justice pour les personnes noires et membre de son groupe directeur. Cette initiative du ministre fédéral de la Justice a présenté 114 recommandations visant à éliminer le racisme envers les personnes noires dans le système de justice canadien. Elle siège actuellement au groupe de mise en œuvre de la Stratégie auprès de Justice Canada. Elle est également ancienne présidente du conseil d’administration de la Société John Howard du Manitoba et membre du conseil d’administration de la Société John Howard du Canada. Elle a remporté le prix d’accès à la justice 2025 de l’Association du Barreau du Manitoba.\n\nConférencière et éducatrice en matière de lutte contre le racisme, Zilla a présenté ses travaux à des groupes partout au pays, notamment à l’Université du Manitoba, au groupe Prison Justice de l’Université Dalhousie, à l’Université de Toronto, à la Société du Barreau du Manitoba, à l’Association canadienne des avocats noirs, à l’Organisation de coopération et de développement économiques, au Fonds de prospérité pour l’avancement des communautés noires, à la Commonwealth Bar Association et à de nombreux autres organismes. Elle a représenté le Canada à deux reprises à l’Instance permanente des Nations Unies pour les personnes d’ascendance africaine.\n\nZilla est aussi une auteure de fiction reconnue, lauréate notamment du prix Journey et du prix Rising Star du Writers’ Trust. Son premier roman, The World So Wide, est paru au printemps dernier. Un recueil de nouvelles suivra en 2027, puis un deuxième roman en 2028.",
    imageUrl: "/speakers/zilla-jones-2026.jpg",
  },
  {
  ...
  {
    "name": "Naomi Gichungu",
    "displayLineEn": "Naomi Gichungu, Co-Founder and CEO, Inuka",
    "bioEn": "Naomi Gichungu (she/her) is a Co-Founder and the CEO of Inuka, an affordable housing provider and Black-led housing developer in Winnipeg, on Treaty 1 territory. At Inuka, she has worked alongside her team to recruit a pool of over 160 potential tenants and provide financial literacy and coaching, credit building, support to repay high-interest revolving debt, employment pathways, driver’s licence training, and mental health supports up to two years before lease-up of Inuka’s first mixed-income, 72-unit building, which includes 41% deeply affordable units. This proactive model supports individuals who are often screened out of housing to qualify for tenancy in the Inuka building and move toward long-term stability and thriving.\n\nNaomi also serves as the Impact Director for the Winnipeg portfolio at The Northpine Foundation, where she invests in initiatives that support individuals to transition out of social assistance through sustained employment and supports adult learners with childcare responsibilities to complete Grade 12, improve literacy and numeracy skills, and access meaningful employment. Previously, she was a Community Investment Manager at United Way Winnipeg, managing a portfolio of 21 funded agencies and two small grant programs.",
    "bioFr": "Naomi Gichungu (elle) est cofondatrice et directrice générale d’Inuka, un fournisseur de logements abordables et un promoteur immobilier dirigé par des personnes noires à Winnipeg, sur le territoire du Traité no 1. Chez Inuka, elle a travaillé avec son équipe pour recruter plus de 160 locataires potentiels et leur offrir de la formation et de l’accompagnement en littératie financière, du soutien pour bâtir leur crédit et rembourser des dettes renouvelables à taux d’intérêt élevé, des parcours vers l’emploi, une formation à la conduite et des services de soutien en santé mentale, jusqu’à deux ans avant la mise en location du premier immeuble à revenus mixtes d’Inuka. Cet immeuble de 72 logements comprend 41 % de logements très abordables. Ce modèle proactif aide des personnes souvent exclues du marché locatif à se qualifier pour un logement dans l’immeuble d’Inuka et à progresser vers une stabilité et un épanouissement durables.\n\nNaomi est également directrice de l’impact pour le portefeuille de Winnipeg à la Fondation Northpine. Elle y investit dans des initiatives qui aident les personnes à sortir de l’aide sociale grâce à un emploi durable et qui soutiennent les apprenants adultes ayant des responsabilités de garde d’enfants pour terminer leur 12e année, améliorer leurs compétences en littératie et en numératie et accéder à un emploi valorisant. Auparavant, elle était gestionnaire des investissements communautaires à Centraide Winnipeg, où elle gérait un portefeuille de 21 organismes financés et deux programmes de petites subventions.",
    "imageUrl": "/speakers/naomi-gichungu-2026.jpg"
  },
  {
    "name": "Jerome Morgan",
    "displayLineEn": "Jerome Morgan, Centre Manager, Centre for the Advancement of Black People, Toronto Community Housing",
    "bioEn": "Jerome Morgan is an innovation leader, strategist, and change agent dedicated to advancing social, housing, and economic transformation. As Centre Manager of the Centre for the Advancement of Black People at Toronto Community Housing (TCHC), Jerome leads initiatives that promote equitable housing policies, strengthen tenant advocacy, and foster community-centered engagement to support the thriving of Black residents across TCHC communities.\n\nAn accomplished leader with extensive experience in community engagement, program management, strategic partnerships, and organizational innovation, Jerome has built a reputation for translating vision into action. His work focuses on strengthening community capacity, advancing resident leadership, and developing solutions that empower individuals, families, and communities to thrive.\n\nJerome holds a Bachelor of Arts in Psychology from Toronto Metropolitan University, with a minor in Business Communications, and a Master of Environmental Studies in Sustainable Development and Community Health from York University. He has also completed postgraduate certifications in Innovation, Strategy, and Leadership (The Banff Centre and University of Waterloo), Community Economic Development (Mount Royal University), and Business Essentials (Schulich School of Business).\n\nThrough his leadership, Jerome continues to champion transformational initiatives that promote housing equity, strengthen community well-being, and create pathways for economic and social advancement. He is passionate about building inclusive communities where Black voices, experiences, and contributions are recognized, valued, and empowered to shape meaningful and lasting change.",
    "bioFr": "Jerome Morgan est un leader en innovation, un stratège et un agent de changement qui œuvre à la transformation sociale, résidentielle et économique. En tant que gestionnaire du Centre for the Advancement of Black People à Toronto Community Housing (TCHC), Jerome dirige des initiatives qui favorisent des politiques de logement équitables, renforcent la défense des droits des locataires et encouragent une mobilisation centrée sur la communauté pour soutenir l’épanouissement des résidents noirs dans les communautés de TCHC.\n\nLeader accompli possédant une vaste expérience en mobilisation communautaire, en gestion de programmes, en partenariats stratégiques et en innovation organisationnelle, Jerome s’est forgé une réputation en concrétisant les visions. Son travail vise à renforcer les capacités communautaires, à faire progresser le leadership des résidents et à élaborer des solutions qui permettent aux personnes, aux familles et aux communautés de s’épanouir.\n\nJerome est titulaire d’un baccalauréat ès arts en psychologie de l’Université métropolitaine de Toronto, avec une mineure en communications d’affaires, et d’une maîtrise en études environnementales axée sur le développement durable et la santé communautaire de l’Université York. Il a également obtenu des certifications de deuxième cycle en innovation, stratégie et leadership (Banff Centre et Université de Waterloo), en développement économique communautaire (Université Mount Royal) et en fondamentaux des affaires (Schulich School of Business).\n\nPar son leadership, Jerome continue de promouvoir des initiatives transformatrices qui favorisent l’équité en logement, renforcent le bien-être communautaire et ouvrent des voies vers l’avancement économique et social. Il est passionné par la création de communautés inclusives où les voix, les expériences et les contributions des personnes noires sont reconnues, valorisées et soutenues pour façonner des changements significatifs et durables.",
    "imageUrl": "/speakers/jerome-morgan-updated-2026.jpg"
  },
  {
  ...
  },
  {
    ...
    "displayLineEn": "Dr. Felicia Masenu, Programs Director, Bilal Community and Family Centre Inc.",
    "bioEn": "Dr. Felicia Masenu is a researcher, community leader, and advocate whose work bridges academic research and community practice, with a focus on restorative justice, newcomer integration, social inequalities, gender equity, and community-led approaches to safety and belonging. She earned her PhD in Anthropology from the University of Manitoba as a Vanier Canada Graduate Scholar, where her research examined gender (in)equality and NGO operational frameworks and practices.\n\nFelicia currently serves as Programs Director at Bilal Community and Family Centre Inc. At the Bilal Community and Family Centre Inc., she supports innovative initiatives that strengthen communities, promote restorative justice, and create pathways for healing and accountability. Drawing on her extensive experience in community engagement, social research, and program development across Canada and Ghana, Felicia is committed to advancing justice through collaboration, inclusion, and culturally responsive solutions.\n\nThrough her work at Bilal Community and Family Centre Inc., Felicia promotes policies and practices that advance equity, justice, and meaningful inclusion. She advocates for community-informed approaches that address systemic barriers, strengthen accountability, and create opportunities for all individuals to thrive.",
    "bioFr": "La Dre Felicia Masenu est chercheuse, leader communautaire et militante. Son travail relie la recherche universitaire à la pratique communautaire, en mettant l’accent sur la justice réparatrice, l’intégration des nouveaux arrivants, les inégalités sociales, l’équité de genre et les approches communautaires de la sécurité et de l’appartenance. Elle a obtenu son doctorat en anthropologie à l’Université du Manitoba en tant que boursière Vanier du Canada. Ses recherches portaient sur l’égalité et les inégalités de genre ainsi que sur les cadres opérationnels et les pratiques des ONG.\n\nFelicia est actuellement directrice des programmes au Bilal Community and Family Centre Inc. Elle y soutient des initiatives novatrices qui renforcent les communautés, favorisent la justice réparatrice et créent des voies vers la guérison et la responsabilisation. Forte d’une vaste expérience en mobilisation communautaire, en recherche sociale et en développement de programmes au Canada et au Ghana, Felicia s’engage à faire progresser la justice par la collaboration, l’inclusion et des solutions adaptées aux réalités culturelles.\n\nPar son travail au Bilal Community and Family Centre Inc., Felicia promeut des politiques et des pratiques qui favorisent l’équité, la justice et une inclusion réelle. Elle défend des approches éclairées par les communautés qui s’attaquent aux obstacles systémiques, renforcent la responsabilisation et créent des possibilités d’épanouissement pour toutes et tous.",
    "imageUrl": "/speakers/felicia-masenu-2026.jpg"
  },
  {
  ...
  {
    name: "Gary Clement",
    // Supplied by the user: Gary Clement bio TD 2026.pdf.
    bioEn: "Gary Clement is a seasoned public affairs expert with over 30 years of government relations, crisis and issues management and stakeholder engagement experience.\n\nGary is currently the Director of Government Relations at TD Bank Group (TDBG) and is responsible for strategies and tactics in managing government relations issues.\n\nBefore joining TDBG, Gary spent more than a decade in provincial and federal governments, serving in senior advisory roles for two Premiers, two cabinet ministers, and a major Crown corporation.\n\nGary has served on the boards of various organizations including currently with the Canadian American Business Council (former Chair), the Michener Awards Foundation, the External Advisory Board of the Brian Mulroney Institute of Government at StFX University and previously with CIVIX, the PC Ontario Fund and the Forum for Young Canadians.\n\nGary is a graduate of the University of Guelph with a Bachelor of Arts (Political Science).",
    bioFr: "Gary Clement est un expert chevronné en affaires publiques qui possède plus de 30 ans d’expérience en relations gouvernementales, en gestion de crises et d’enjeux, ainsi qu’en mobilisation des parties prenantes.\n\nGary est actuellement directeur des relations gouvernementales au Groupe Banque TD et est responsable des stratégies et des tactiques de gestion des enjeux liés aux relations gouvernementales.\n\nAvant de se joindre au Groupe Banque TD, Gary a passé plus de dix ans au sein des gouvernements provinciaux et fédéral, où il a occupé des fonctions de conseiller principal auprès de deux premiers ministres provinciaux, de deux ministres et d’une importante société d’État.\n\nGary a siégé aux conseils d’administration de divers organismes. Il siège actuellement au Canadian American Business Council, dont il a été président, à la Fondation des Prix Michener et au conseil consultatif externe du Brian Mulroney Institute of Government de l’Université St. Francis Xavier. Il a auparavant siégé aux conseils de CIVIX, du PC Ontario Fund et du Forum pour jeunes Canadiens.\n\nGary est titulaire d’un baccalauréat ès arts en sciences politiques de l’Université de Guelph.",
