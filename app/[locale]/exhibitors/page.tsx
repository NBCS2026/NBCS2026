...
export default function ExhibitorsPage() {
  ...
  return (
    <>
      <div className="relative flex min-h-[100svh] flex-col bg-[linear-gradient(to_bottom,rgba(42,4,18,0.9),rgba(93,24,49,0.58)),url('/about_main.webp')] bg-cover bg-[center_60%]">
