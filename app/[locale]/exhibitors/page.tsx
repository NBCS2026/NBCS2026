...
export default function ExhibitorsPage() {
  ...
  return (
    <>
      <div className="relative flex min-h-[100svh] flex-col bg-[linear-gradient(to_bottom,rgba(93,8,38,0.9),rgba(142,12,58,0.58)),url('/about_main.webp')] bg-cover bg-[center_60%]">
        ...
        <div className="mx-auto flex w-full flex-1 max-w-[1180px] flex-col items-center justify-center px-5 py-16 text-center text-white">
