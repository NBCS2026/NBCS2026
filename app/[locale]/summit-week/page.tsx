...
export default function SummitWeekPage() {
  ...
  return (
    <>
      <div className="relative min-h-[72vh] bg-[linear-gradient(to_bottom,rgba(42,4,18,0.88),rgba(93,24,49,0.58)),url('/oodena-celebration-circle.jpg')] bg-cover bg-center">
