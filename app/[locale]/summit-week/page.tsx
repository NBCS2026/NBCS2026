...
export default function SummitWeekPage() {
  ...
  return (
    <>
      <div className="relative flex min-h-[100svh] flex-col bg-[linear-gradient(to_bottom,rgba(93,8,38,0.88),rgba(142,12,58,0.58)),url('/summit-week-hero-394A4974.jpg')] bg-cover bg-[center_40%]">
