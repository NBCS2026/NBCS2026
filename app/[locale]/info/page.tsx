...
import { WayfindingGuide } from "@/components/wayfinding-guide";
...
export default function Page() {
  ...
  return (
    <>
      <div className="site-hero min-h-[100svh] flex flex-col relative bg-[linear-gradient(to_bottom,rgba(93,8,38,0.8)_0%,rgba(142,12,58,0.6)_32%,rgba(142,12,58,0.4)_66%,rgba(142,12,58,0.2)_100%),url('/contact_main.webp')] bg-cover bg-center">
