...
export default function Page() {
  ...
  return (
    <>
      <div className="site-hero min-h-[100svh] flex flex-col relative bg-[linear-gradient(to_bottom,rgba(93,8,38,0.9)_10%,rgba(142,12,58,0.7)_42%,rgba(142,12,58,0.5)_76%,rgba(142,12,58,0.3)_110%),url('/contact-hero-394A4321.jpg')] bg-cover bg-center">
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <input
                    ...
                    maxLength={120}
                    autoComplete="name"
                    className="w-full px-4 py-3 palette-field border border-[#967984] rounded-lg focus:outline-none focus:ring-2 focus:ring-light-red focus:border-transparent"
                    required
                ...
                <div>
                  ...
                  <textarea
                    ...
                    maxLength={4000}
                    rows={6}
                    className="w-full px-4 py-3 palette-field border border-[#967984] rounded-lg focus:outline-none focus:ring-2 focus:ring-light-red focus:border-transparent resize-vertical"
                    required
                    disabled={isSubmitting}
                  ></textarea>
                </div>
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full bg-light-red text-white font-semibold py-3 px-6 rounded-lg hover:bg-dark-red transition-colors focus:outline-none focus:ring-2 focus:ring-light-red focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
