...
export default function Page() {
  ...
  return (
    <>
      <div className="relative flex min-h-[100svh] flex-col bg-[linear-gradient(to_bottom,rgba(93,8,38,0.8)_0%,rgba(142,12,58,0.6)_32%,rgba(142,12,58,0.4)_66%,rgba(142,12,58,0.2)_100%),url('/media-hero.webp')] bg-cover bg-center">
        ...
        <div className="flex w-full max-w-[1440px] flex-1 flex-col justify-center mx-auto px-5 py-16 2xl:max-w-[1600px] 2xl:px-8 3xl:max-w-[1800px] 3xl:px-16 4xl:max-w-[2400px] 4xl:px-24 text-center">
