...
export default function Page() {
  ...
  useEffect(() => {
    ...
    const loadScripts = () => {
      ...
      ticketsScript.id =
        "bz-inline-registration-script-952c7914-98bb-4958-8add-066e946ee763";
      ticketsScript.setAttribute("data-event-id", "792278");
      ticketsScript.setAttribute("data-locale", localeValue);
      
      // Error handling for script loading
      ticketsScript.onerror = () => {
        console.error('Failed to load Bizzabo tickets script');
      };
      ...
      popupScript.id =
        "bz-popup-registration-script-952c7914-98bb-4958-8add-066e946ee763";
      popupScript.setAttribute("data-event-id", "792278");
      popupScript.setAttribute("data-registration-proxy", "true");
      popupScript.setAttribute("data-unique-name", "792278");
      ...
      // Error handling for script loading
      popupScript.onerror = () => {
        console.error('Failed to load Bizzabo popup script');
      };
        ...
        <section className="bg-[#F5F5F5] py-8 sm:py-12 md:py-16">
          <div className="max-w-[1568px] 2xl:max-w-[1800px] mx-auto px-4 sm:px-5 2xl:px-8">
            ...
            <div
              ...
              {/* French Registration Button - Show below widget for French users */}
              {locale === "fr" && (
                <div className="mt-8 md:mt-12 text-center">
                  <Button
                    onClick={() => window.open("https://events.bizzabo.com/792278", "_blank")}
